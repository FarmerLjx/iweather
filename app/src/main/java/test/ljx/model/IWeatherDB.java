...
import test.ljx.db.IWeatherOpenHelper;

/**
 * Created by peenut on 2016/4/13.
 */
public class IWeatherDB {
    ...
    ** 数据库版本
    ...
    private IWeatherDB(Context context) {
        IWeatherOpenHelper dbHelper = new IWeatherOpenHelper(context, DB_NAME, null, DB_VERSION);
